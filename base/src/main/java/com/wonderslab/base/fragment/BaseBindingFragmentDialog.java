...
public abstract class BaseBindingFragmentDialog<Binding extends ViewDataBinding, ViewInterface extends BaseView,
        ViewModel extends BaseViewModel<ViewInterface>> extends DialogFragment implements BaseView {
