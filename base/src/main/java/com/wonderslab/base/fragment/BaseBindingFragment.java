...
public abstract class BaseBindingFragment<Binding extends ViewDataBinding, ViewInterface extends BaseView,
        ViewModel extends BaseViewModel<ViewInterface>> extends Fragment implements BaseView {
