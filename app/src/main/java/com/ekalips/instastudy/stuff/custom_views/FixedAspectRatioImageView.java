...
public class FixedAspectRatioImageView extends AppCompatImageView {
    ...
    public FixedAspectRatioImageView(Context context, AttributeSet attrs) {
        ...
        aspectRatioEnabled = a.getBoolean(R.styleable.FixedAspectRatioImageView_aspectRatioEnabled,
                DEFAULT_ASPECT_RATIO_ENABLED);
        dominantMeasurement = a.getInt(R.styleable.FixedAspectRatioImageView_dominantMeasurement,
